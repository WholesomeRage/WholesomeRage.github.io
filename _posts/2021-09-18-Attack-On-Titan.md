...
When _Attack on Titan_ came out, it got big, and it got big fast. [To this day it’s one of the best-selling manga in the world, with over 100 million copies sold](https://en.wikipedia.org/wiki/List_of_best-selling_manga#At_least_100_million_copies_and_above), and [while the ending angered many](https://www.reddit.com/r/titanfolk/), one can’t argue that this series, whether through the manga itself or through the [incredibly popular anime adaptation](https://en.wikipedia.org/wiki/Attack_on_Titan_(TV_series)#Sales_and_accolades), made a lot of noise. There are [movies about *Attack on Titan*](https://en.wikipedia.org/wiki/Attack_on_Titan_(film)), [books about *Attack on Titan*](https://en.wikipedia.org/wiki/Attack_on_Titan:_Before_the_Fall), [videogames](https://en.wikipedia.org/wiki/Attack_on_Titan_(video_game)), a [Marvel crossover](https://en.wikipedia.org/wiki/Attack_on_Titan#Other_media). It’s not a series, it’s a _media empire._
